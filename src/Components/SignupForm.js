...
const SignupForm = () => {
  ...
  return (
    <div >
      <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '20px', textAlign: 'center' }}>Sign Up</h1>
      <Formik
        initialValues={{
          firstName: '',
          lastName: '',
        ...
        {({ isSubmitting }) => (
          ...
          <Form>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <button style={{ width: '100%', padding: '10px', fontSize: '1rem', borderRadius: '20px', backgroundColor: '#2471A3', color: 'white', cursor: 'pointer' }} type="submit" disabled={isSubmitting}>
                Submit
              </button>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px', textAlign: 'center', marginTop: '20px', textAlign: 'center' }}>
              <p style={{ fontSize: '0.9rem', color: 'white', textDecoration: 'underline' }}>Already have an account</p>
            </div>
          </Form>
          </div>
        )}
